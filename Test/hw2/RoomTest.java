...
public class RoomTest {
  ...
  public void isAvailable() {
    Room roomOne = new Room(RoomType.SINGLE_ROOM,150);
  ...
  public void bookRoomTest() {
    Room roomTwo = new Room(RoomType.SINGLE_ROOM, 80);
    roomTwo.bookRoom(1);
    assertEquals(1, roomTwo.getNumberOfGuests());
    roomTwo.bookRoom(1);
    assertEquals(1, roomTwo.getNumberOfGuests());
    Room roomThree = new Room(RoomType.DOUBLE_ROOM, 160);
    roomThree.bookRoom(3);
    assertEquals(0, roomThree.getNumberOfGuests());
    Room roomFour = new Room(RoomType.FAMILY_ROOM, 220);
    roomFour.bookRoom(4);
  ...
  public void getNumberOfGuests() {
    Room roomFive = new Room(RoomType.SINGLE_ROOM, 140);
